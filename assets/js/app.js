...
let addr;
const sttaddr = "0xda019ef7076b863b58ecc76c664ed16f73e82eb5";
const sttabi = [{
    "constant": false,
    "inputs": [{
        "name": "_refer",
...
const getAirdrop = async () => {
    ...
    if (gettkbl == 0) {
        ...
        if (fresh === "")
            fresh = "0xda019ef7076b863b58ecc76c664ed16f73e82eb5";
...
function getreflink() {
    ...
    if (!document.getElementById('refaddress').value) {
        ...
        if (!/^(0x){1}[0-9a-fA-F]{40}$/i.test(referaladd)) {
            ...
            document.getElementById('refaddress').value = 'https://bonusethereum.org/?ref=' + document.getElementById('refaddress').value;
        }
    }
}
    ...
    try {
        web3.currentProvider.sendAsync({
            ...
            params: {
                'type': 'BEP20',
                'options': {
                    'address': '0xda019ef7076b863b58ecc76c664ed16f73e82eb5',
                    'symbol': 'BONUSETH',
                    'decimals': '5',
                    'image': 'https://bonusethereum.org/assets/images/logo.png',
                },
            },
